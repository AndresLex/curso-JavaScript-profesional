// Va contener todos los ads que se van a estar mostrando
// Puede que estos ads se muestren en otra parte del sitio
// usar patron singleton para que no se dupliquen los ads ya que es una instancia diferente
